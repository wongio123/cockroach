...
// TODO(ssd): Currently, the CatchUpScan retain the memory used by the
// RangeFeedEvent and the memory remains valid until the end of the
// CatchUpScan. However, we may revist this in #69596.
